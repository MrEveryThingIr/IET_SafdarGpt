...
<section class="min-h-screen flex items-center justify-center bg-gray-100 px-4 py-12">
    <form action="<?= route('recoverpassword.reset'); ?>" 
          method="POST"
        ...
        <button type="submit"
                class="w-full bg-green-600 hover:bg-green-700 text-white font-semibold py-2 px-4 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition">
            Reset Password
        </button>
    </form>
</section>
