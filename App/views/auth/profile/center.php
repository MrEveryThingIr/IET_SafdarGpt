...
use App\HTMLRenderer\Sidebar;
    ...
    //         'items' => [
    //             ['label' => 'مشخصات فردی', 'href' => route('user.profile',['feature'=>'identification','user_id'=>user()['id']]),'class'=>'bg-blue-600 m-2 hover:bg-blue-700 text-white px-4 py-2 rounded transition'],
    ...
    //             ['label' => 'اعلام ها', 'href' => route('user.profile',['feature'=>'my_announces','user_id'=>user()['id']]),'class'=>'bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded transition'],
...
switch($feature){
    case 'identification':
        ...
        break;
    case 'my_supplies':
        include views_path('/auth/profile/my_supplies.php');
        break;
    case 'my_demands':
        include views_path('/auth/profile/my_demands.php');
        break;
    case 'my_announces':
    ...
    case 'my_articles':
        include views_path('auth/profile/my_articles.php');
        break;

    case 'my_chatrooms':
        include views_path('auth/profile/my_chatrooms.php');
        break;
